package com.my.my.socket.protobuf;

import com.google.protobuf.InvalidProtocolBufferException;
import com.google.protobuf.util.JsonFormat;

public class TestProtoMain {
    public static void main(String[] args) {

        System.out.println("===== 构建一个GPS模型开始 =====");
        socket.protobuf.TestData.gps_data.Builder gps_builder = socket.protobuf.TestData.gps_data.newBuilder();
        ...
        socket.protobuf.TestData.gps_data gps_data = gps_builder.build();
        ...
        socket.protobuf.TestData.gps_data gd = null;
        try {
            gd = socket.protobuf.TestData.gps_data.parseFrom(gps_data.toByteArray());
